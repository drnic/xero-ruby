  ...
  class Contact
    ...
    class EnumAttributeValidator
      ...
      def initialize(datatype, allowable_values)
        @allowable_values = allowable_values.map { |value|
          case datatype.to_s
          when /Integer/i
            value.to_i
          when /Float/i
    ...
    def initialize(attributes = {})
      ...
      self.has_attachments = if attributes.key?(:has_attachments)
        attributes[:has_attachments]
      else
        false
      end
      ...
      self.has_validation_errors = if attributes.key?(:has_validation_errors)
        attributes[:has_validation_errors]
      else
        false
      end
    ...
    def parse_date(datestring)
      ...
      Time.at(seconds_since_epoch).to_s
    end
  end
end
