...
module XeroRuby
  class ProjectApi
    ...
    def get_projects_with_http_info(xero_tenant_id, opts = {})
      ...
      # query parameters
      query_params = opts[:query_params] || {}
      query_params[:projectIds] = @api_client.build_collection_param(opts[:project_ids], :multi) unless opts[:project_ids].nil?
      query_params[:contactID] = opts[:contact_id] unless opts[:contact_id].nil?
      query_params[:states] = opts[:states] unless opts[:states].nil?
      query_params[:page] = opts[:page] unless opts[:page].nil?
      query_params[:pageSize] = opts[:page_size] unless opts[:page_size].nil?
    ...
    def get_tasks_with_http_info(xero_tenant_id, project_id, opts = {})
      ...
      query_params[:page] = opts[:page] unless opts[:page].nil?
      query_params[:pageSize] = opts[:page_size] unless opts[:page_size].nil?
      query_params[:taskIds] = opts[:task_ids] unless opts[:task_ids].nil?
    ...
    def get_time_entries_with_http_info(xero_tenant_id, project_id, opts = {})
      ...
      # query parameters
      query_params = opts[:query_params] || {}
      query_params[:userId] = opts[:user_id] unless opts[:user_id].nil?
      query_params[:taskId] = opts[:task_id] unless opts[:task_id].nil?
      query_params[:invoiceId] = opts[:invoice_id] unless opts[:invoice_id].nil?
      query_params[:contactId] = opts[:contact_id] unless opts[:contact_id].nil?
      query_params[:page] = opts[:page] unless opts[:page].nil?
      query_params[:pageSize] = opts[:page_size] unless opts[:page_size].nil?
      query_params[:states] = @api_client.build_collection_param(opts[:states], :multi) unless opts[:states].nil?
      query_params[:isChargeable] = opts[:is_chargeable] unless opts[:is_chargeable].nil?
      query_params[:dateAfterUtc] = opts[:date_after_utc] unless opts[:date_after_utc].nil?
      query_params[:dateBeforeUtc] = opts[:date_before_utc] unless opts[:date_before_utc].nil?
