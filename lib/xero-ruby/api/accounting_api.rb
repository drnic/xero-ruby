...
module XeroRuby
  class AccountingApi
    ...
    def create_account_with_http_info(xero_tenant_id, account, opts = {})
      ...
      opts[:where] = @api_client.parameterize_where(opts[:where]) unless opts[:where].nil?

      # query parameters
      query_params = opts[:query_params] || {}

      # XeroAPI's `IDs` convention openapi-generator does not snake_case properly.. manual over-riding `i_ds` malformations:
      query_params[:IDs] = @api_client.build_collection_param(opts[:ids], :csv) unless opts[:ids].nil?
      query_params[:ContactIDs] = @api_client.build_collection_param(opts[:contact_ids], :csv) unless opts[:contact_ids].nil?
    ...
    def create_bank_transactions_with_http_info(xero_tenant_id, bank_transactions, opts = {})
      ...
      # query parameters
      query_params = opts[:query_params] || {}
      query_params[:summarizeErrors] = opts[:summarize_errors] unless opts[:summarize_errors].nil?
      query_params[:unitdp] = opts[:unitdp] unless opts[:unitdp].nil?
    ...
    def create_credit_note_attachment_by_file_name_with_http_info(xero_tenant_id, credit_note_id, file_name, body, opts = {})
      ...
      # query parameters
      query_params = opts[:query_params] || {}
      query_params[:IncludeOnline] = opts[:include_online] unless opts[:include_online].nil?
    ...
    def get_accounts_with_http_info(xero_tenant_id, opts = {})
      ...
      # query parameters
      query_params = opts[:query_params] || {}
      query_params[:where] = opts[:where] unless opts[:where].nil?
      ...
      header_params["Accept"] = @api_client.select_header_accept(["application/json"])
      header_params[:'xero-tenant-id'] = xero_tenant_id
      header_params[:'If-Modified-Since'] = opts[:if_modified_since] unless opts[:if_modified_since].nil?
    ...
    def get_contacts_with_http_info(xero_tenant_id, opts = {})
      ...
      query_params[:where] = opts[:where] unless opts[:where].nil?
      query_params[:order] = opts[:order] unless opts[:order].nil?
      query_params[:IDs] = @api_client.build_collection_param(opts[:i_ds], :csv) unless opts[:i_ds].nil?
      query_params[:page] = opts[:page] unless opts[:page].nil?
      query_params[:includeArchived] = opts[:include_archived] unless opts[:include_archived].nil?
    ...
    def get_invoices_with_http_info(xero_tenant_id, opts = {})
      ...
      query_params[:order] = opts[:order] unless opts[:order].nil?
      query_params[:IDs] = @api_client.build_collection_param(opts[:i_ds], :csv) unless opts[:i_ds].nil?
      query_params[:InvoiceNumbers] = @api_client.build_collection_param(opts[:invoice_numbers], :csv) unless opts[:invoice_numbers].nil?
      query_params[:ContactIDs] = @api_client.build_collection_param(opts[:contact_i_ds], :csv) unless opts[:contact_i_ds].nil?
      query_params[:Statuses] = @api_client.build_collection_param(opts[:statuses], :csv) unless opts[:statuses].nil?
      query_params[:page] = opts[:page] unless opts[:page].nil?
      query_params[:includeArchived] = opts[:include_archived] unless opts[:include_archived].nil?
      query_params[:createdByMyApp] = opts[:created_by_my_app] unless opts[:created_by_my_app].nil?
      query_params[:unitdp] = opts[:unitdp] unless opts[:unitdp].nil?
    ...
    def get_journals_with_http_info(xero_tenant_id, opts = {})
      ...
      query_params[:paymentsOnly] = opts[:payments_only] unless opts[:payments_only].nil?
    ...
    def get_linked_transactions_with_http_info(xero_tenant_id, opts = {})
      ...
      query_params = opts[:query_params] || {}
      query_params[:page] = opts[:page] unless opts[:page].nil?
      query_params[:LinkedTransactionID] = opts[:linked_transaction_id] unless opts[:linked_transaction_id].nil?
      query_params[:SourceTransactionID] = opts[:source_transaction_id] unless opts[:source_transaction_id].nil?
      query_params[:ContactID] = opts[:contact_id] unless opts[:contact_id].nil?
      query_params[:Status] = opts[:status] unless opts[:status].nil?
      query_params[:TargetTransactionID] = opts[:target_transaction_id] unless opts[:target_transaction_id].nil?
    ...
    def get_purchase_orders_with_http_info(xero_tenant_id, opts = {})
      ...
      query_params = opts[:query_params] || {}
      query_params[:Status] = opts[:status] unless opts[:status].nil?
      query_params[:DateFrom] = opts[:date_from] unless opts[:date_from].nil?
      query_params[:DateTo] = opts[:date_to] unless opts[:date_to].nil?
      query_params[:order] = opts[:order] unless opts[:order].nil?
      query_params[:page] = opts[:page] unless opts[:page].nil?
    ...
    def get_quotes_with_http_info(xero_tenant_id, opts = {})
      ...
      query_params[:DateFrom] = opts[:date_from] unless opts[:date_from].nil?
      query_params[:DateTo] = opts[:date_to] unless opts[:date_to].nil?
      query_params[:ExpiryDateFrom] = opts[:expiry_date_from] unless opts[:expiry_date_from].nil?
      query_params[:ExpiryDateTo] = opts[:expiry_date_to] unless opts[:expiry_date_to].nil?
      query_params[:ContactID] = opts[:contact_id] unless opts[:contact_id].nil?
      query_params[:Status] = opts[:status] unless opts[:status].nil?
      query_params[:page] = opts[:page] unless opts[:page].nil?
      query_params[:order] = opts[:order] unless opts[:order].nil?
    ...
    def get_report_aged_payables_by_contact_with_http_info(xero_tenant_id, contact_id, opts = {})
      ...
      query_params[:date] = opts[:date] unless opts[:date].nil?
      query_params[:fromDate] = opts[:from_date] unless opts[:from_date].nil?
      query_params[:toDate] = opts[:to_date] unless opts[:to_date].nil?
    ...
    def get_report_balance_sheet_with_http_info(xero_tenant_id, opts = {})
      ...
      query_params = opts[:query_params] || {}
      query_params[:date] = opts[:date] unless opts[:date].nil?
      query_params[:periods] = opts[:periods] unless opts[:periods].nil?
      query_params[:timeframe] = opts[:timeframe] unless opts[:timeframe].nil?
      query_params[:trackingOptionID1] = opts[:tracking_option_id1] unless opts[:tracking_option_id1].nil?
      query_params[:trackingOptionID2] = opts[:tracking_option_id2] unless opts[:tracking_option_id2].nil?
      query_params[:standardLayout] = opts[:standard_layout] unless opts[:standard_layout].nil?
      query_params[:paymentsOnly] = opts[:payments_only] unless opts[:payments_only].nil?
    ...
    def get_report_budget_summary_with_http_info(xero_tenant_id, opts = {})
      ...
      query_params = opts[:query_params] || {}
      query_params[:date] = opts[:date] unless opts[:date].nil?
      query_params[:period] = opts[:period] unless opts[:period].nil?
      query_params[:timeframe] = opts[:timeframe] unless opts[:timeframe].nil?
    ...
    def get_report_profit_and_loss_with_http_info(xero_tenant_id, opts = {})
      ...
      query_params[:periods] = opts[:periods] unless opts[:periods].nil?
      query_params[:timeframe] = opts[:timeframe] unless opts[:timeframe].nil?
      query_params[:trackingCategoryID] = opts[:tracking_category_id] unless opts[:tracking_category_id].nil?
      query_params[:trackingCategoryID2] = opts[:tracking_category_id2] unless opts[:tracking_category_id2].nil?
      query_params[:trackingOptionID] = opts[:tracking_option_id] unless opts[:tracking_option_id].nil?
      query_params[:trackingOptionID2] = opts[:tracking_option_id2] unless opts[:tracking_option_id2].nil?
      query_params[:standardLayout] = opts[:standard_layout] unless opts[:standard_layout].nil?
      query_params[:paymentsOnly] = opts[:payments_only] unless opts[:payments_only].nil?
    ...
    def get_report_ten_ninety_nine_with_http_info(xero_tenant_id, opts = {})
      ...
      # query parameters
      query_params = opts[:query_params] || {}
      query_params[:reportYear] = opts[:report_year] unless opts[:report_year].nil?
    ...
    def get_tax_rates_with_http_info(xero_tenant_id, opts = {})
      ...
      query_params[:where] = opts[:where] unless opts[:where].nil?
      query_params[:order] = opts[:order] unless opts[:order].nil?
      query_params[:TaxType] = opts[:tax_type] unless opts[:tax_type].nil?
